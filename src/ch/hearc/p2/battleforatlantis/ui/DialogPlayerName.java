...
public class DialogPlayerName
{
	...
	{
		String newName = (String) JOptionPane.showInputDialog(parent, Messages.getString("DialogPlayerName.Message"),
				Messages.getString("DialogPlayerName.Title"), JOptionPane.QUESTION_MESSAGE, null, null, oldName);
